...
def write():
    ...
    if len(df) != 0:
        ...
        def Sygeplejerske_forhydrering_export():
            df["Sygeplejerske_navn_forhydering"][df_st["selected_treatment"][0]] = Sygeplejerske_navn_forhydering
            df["Sygeplejerske_tid_forhydering"][df_st["selected_treatment"][0]] = Sygeplejerske_tid_forhydering
        ...
        if df["Plasma_kreatin_før_start"][df_st["selected_treatment"][0]] == "":
            Plasma_kreatin_før_start = st.number_input('Plasma kreatinin før start af kuren µmol/l', min_value=0, value=0)
        if df["Plasma_kreatin_før_start"][df_st["selected_treatment"][0]] != "":
            Plasma_kreatin_før_start = st.number_input('Plasma kreatinin før start af kuren µmol/l', min_value=0, value=int(df["Plasma_kreatin_før_start"][df_st["selected_treatment"][0]]))
        df.loc[df_st["selected_treatment"][0],"Plasma_kreatin_før_start"] = Plasma_kreatin_før_start
        df.to_excel(Destination_main_file)
